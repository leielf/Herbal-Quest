...
public class ElixirApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        lvlManager.startStage(stage, "/Users/leielf/Downloads/second_json.json");
//        Pane pane = new Pane();
...
//        lvlLoader.addToLevel(pane, "/Users/leielf/Downloads/second_json.json");
...
//        timer.start();
    ...
    private void processKey(KeyCode code, boolean on) {
        switch (code) {
            case LEFT:
                player.setLeft(on) ;
                logger.log(Level.INFO, "<- was clicked");
                break ;
            case RIGHT:
                player.setRight(on);
                logger.log(Level.INFO, "-> was clicked");
